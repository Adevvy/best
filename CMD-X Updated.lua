...
function useCommand.creatoridpublic()
	...
	cmdrs.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("The creator of the games id is "..game.CreatorId,"All")
end
...
function useCommand.using()
	opx("-","Said script <3")
	cmdrs.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("I am using CMD-X, Version: "..ver, "All")
end
...
function useCommand.nazispam()
	opx("-","Heil hitler?")
	hitler = true
	local req = cmdrs.DefaultChatSystemChatEvents.SayMessageRequest
	function say(msg)
...
function useCommand.dicepublic()
	...
	cmdrs.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("The dice rolled by "..cmdlp.Name.." rolled a ".. tostring(math.random(1, 6)), "All")
end
...
function useCommand.numberpublic()
	if arguments[3] then
		...
		cmdrs.DefaultChatSystemChatEvents.SayMessageRequest:FireServer(cmdlp.Name.." has picked a random number between "..arguments[2].." and "..arguments[3].." the number is ".. tostring(math.random(arguments[2], arguments[3])), "All")
	else
...
function useCommand.time()
	if arguments[2] then
		...
		cmdrs.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("The time in "..arguments[2].." is "..Time,"All")
	else
		opx("*","2 arguments are required!")
end
end
...
function useCommand.sing()
	...
	cmdrs.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Now singing "..songTitle, "All")
	...
	for i,v in pairs(lyricsTable) do
		...
		wait(5)
		if stopSingMid == true then break end
		cmdrs.DefaultChatSystemChatEvents.SayMessageRequest:FireServer(v, "All")
	end
	wait(5)
	cmdrs.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Finished singing "..songTitle, "All")
end
...
function useCommand.bypass()
	if _G.oldhook or _G.soldhook or _G.ssoldhook or _G.sssoldhook then
...
function useCommand.nilchatcmds()
	if _G.soldhook or _G.ssoldhook or _G.oldhook or _G.sssoldhook then
...
function useCommand.saydiscord()
	...
	cmdrs.DefaultChatSystemChatEvents.SayMessageRequest:FireServer(discordTag, "All")
...
function useCommand.chat()
	if arguments[2] then
		...
		cmdrs.DefaultChatSystemChatEvents.SayMessageRequest:FireServer(chatString, "All")
...
function useCommand.lagchat()
	...
	while chatlag do
		wait()
		cmdrs.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("_______________________________________", "All")
	end
end
...
function useCommand.clearchat()
	opx("-","Cleared chat")
	for i = 1,3 do
		cmdrs.DefaultChatSystemChatEvents.SayMessageRequest:FireServer(string.rep("â¸»", 200), "All")
	end
end
